...
CTA_PATTERNS = [
    r"\bподпис\w*", r"\bставьте\b", r"\bжми\w*", r"\bчитайте\b", r"\bузнай\w*",
    r"\bсмотрите\b", r"\bпишите\b", r"\bделитесь\b", r"\bкоммент\w*",
    r"\bлайк\w*", r"\bсохрани\w*", r"\bпопробуйте\b", r"\bскачайте\b",
]
